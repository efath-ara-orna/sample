      ...
      <div class="container">
        <div class="middle-section text-center">
          <div class="section-width">
            <p>It's great to be In Shopping Mall!</p>
                    ...
                    <a href="property-single.html">
                        <div class="box16">
                            ...
                            <div class="box-content">
                                <h3 class="title">{{$data->price }} tk</h3>
                                <span class="post">{{$data->shopName }}</span>
                                <span class="post">{{$data->floorNo }}</span>
                                <span class="post">{{$data->blockNo }}</span>
        ...
        <div class="container py-lg-5 py-md-4">
            ...
            <div class="row pt-5">
                <div class="col-lg-3 col-md-4 col-6">
                    <a href="#url">
                        <div class="box16">
                            <img class="img-fluid" src="{{asset('frontend')}}/assets/images/p1.jpg" alt="">
                            <div class="box-content">
                ...
                <div class="col-lg-3 col-md-4 col-6">
                    <a href="#url">
                        <div class="box16">
                            <img class="img-fluid" src="{{asset('frontend')}}/assets/images/p2.jpg" alt="">
                            <div class="box-content">
                ...
                <div class="col-lg-3 col-md-4 col-6 mt-md-0 pt-md-0 mt-sm-4 mt-3 pt-md-2">
                    <a href="#url">
                        <div class="box16">
                            <img class="img-fluid" src="{{asset('frontend')}}/assets/images/p3.jpg" alt="">
                            <div class="box-content">
                ...
                <div class="col-lg-3 col-md-4 col-6 mt-lg-0 pt-lg-0 mt-sm-4 mt-3 pt-md-2">
                    <a href="#url">
                        <div class="box16">
                            <img class="img-fluid" src="{{asset('frontend')}}/assets/images/p4.jpg" alt="">
                            <div class="box-content">
                ...
                <div class="col-lg-3 col-md-4 col-6 mt-sm-4 mt-3 pt-md-2">
                    <a href="#url">
                        <div class="box16">
                            <img class="img-fluid" src="{{asset('frontend')}}/assets/images/p5.jpg" alt="">
                            <div class="box-content">
                ...
                <div class="col-lg-3 col-md-4 col-6 mt-sm-4 mt-3 pt-md-2">
                    <a href="#url">
                        <div class="box16">
                            <img class="img-fluid" src="{{asset('frontend')}}/assets/images/p6.jpg" alt="">
                            <div class="box-content">
                ...
                <div class="col-lg-3 col-md-4 col-6 mt-sm-4 mt-3 pt-md-2">
                    <a href="#url">
                        <div class="box16">
                            <img class="img-fluid" src="{{asset('frontend')}}/assets/images/p8.jpg" alt="">
                            <div class="box-content">
                                <h3 class="title mb-1">Newyork</h3>
                                <span class="post">4 listings</span>
                            </div>
            ...
            <div class="row mt-lg-5 mt-4 pt-3">
                <div class="col-lg-4 col-md-6 mt-md-0 mt-sm-4">
                    <div class="grids5-info">
                        ...
                        <a href="#blog-single" class="d-block zoom"><img src="{{asset('frontend')}}/assets/images/p1.jpg" alt=""
                ...
                <div class="col-lg-4 col-md-6 mt-md-0 mt-5">
                    <div class="grids5-info">
                        ...
                        <a href="#blog-single" class="d-block zoom"><img src="{{asset('frontend')}}/assets/images/p2.jpg" alt=""
                                class="img-fluid news-image" /></a>
                        <div class="blog-info">
                            <a href="#category" class="category">Uncategorized</a>
                ...
                <div class="col-lg-4 col-md-6 mt-lg-0 mt-5">
                    <div class="grids5-info">
                        ...
                        <a href="#blog-single" class="d-block zoom"><img src="{{asset('frontend')}}/assets/images/p3.jpg" alt=""
                                class="img-fluid news-image" /></a>
                        <div class="blog-info">
                            <a href="#category" class="category">Uncategorized</a>
            ...
            <div class="row">
                <div class="col-lg-2 col-md-4 col-6 column">
                    <div class="company-gd">
                        <a href="#client"><img class="img-responsive" src="{{asset('frontend')}}/assets/images/client1.png" alt="client"> </a>
                    </div>
                </div>
                <div class="col-lg-2 col-md-4 col-6 column">
                    <div class="company-gd">
                        <a href="#client"><img class="img-responsive" src="{{asset('frontend')}}/assets/images/client2.png" alt="client"> </a>
                    </div>
                </div>
                <div class="col-lg-2 col-md-4 col-6 column mt-md-0 mt-4">
                    <div class="company-gd">
                        <a href="#client"><img class="img-responsive" src="{{asset('frontend')}}/assets/images/client3.png" alt="client"> </a>
                    </div>
                </div>
                <div class="col-lg-2 col-md-4 col-6 column mt-lg-0 mt-4">
                    <div class="company-gd">
                        <a href="#client"><img class="img-responsive" src="{{asset('frontend')}}/assets/images/client4.png" alt="client"> </a>
                    </div>
                </div>
                <div class="col-lg-2 col-md-4 col-6 column mt-lg-0 mt-4">
                    <div class="company-gd">
                        <a href="#client"><img class="img-responsive" src="{{asset('frontend')}}/assets/images/client5.png" alt="client"> </a>
                    </div>
                </div>
                <div class="col-lg-2 col-md-4 col-6 column mt-lg-0 mt-4">
                    <div class="company-gd">
                        <a href="#client"><img class="img-responsive" src="{{asset('frontend')}}/assets/images/client6.png" alt="client"> </a>
                    </div>
                </div>
            </div>
        </div>
