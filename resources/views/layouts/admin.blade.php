...
<head>
  ...
  <title>Shopping Mall Management| Admin Dashboard</title>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="{{url('admin/bill/all')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Contact Us</p>
                </a>
              </li>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{url('admin/shopdetails')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add Shop Details</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{url('admin/shopdetails/all')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Show Shop Details</p>
                </a>
              </li>
              </ul>
