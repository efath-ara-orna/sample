  ...
  <div class="container">
      <nav class="navbar navbar-expand-lg stroke px-0">
          <h1> <a class="navbar-brand" href="index.html">
                  <span class="fa fa-home"></span>RD Shopping MAll
              </a></h1>
          ...
          <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
              <ul class="navbar-nav ml-lg-5 mr-auto">
                  ...
                  <li class="nav-item dropdown @@pages__active">
                      ...
                      <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                          <a class="dropdown-item @@about__active" href="{{route('home.about')}}">About us</a>
...
<script src="{{asset('frontend')}}/assets/js/theme-change.js"></script><!-- theme switch js (light and dark)-->
